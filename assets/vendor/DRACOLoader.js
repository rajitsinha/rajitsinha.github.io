/* three.js DRACOLoader r185, from three@0.185.0/examples/jsm/loaders/DRACOLoader.js.
   MIT licensed, (c) 2010-2025 three.js authors.
   Vendored rather than pulled from a CDN so the site keeps working with no
   third-party network dependency. The only change is the import specifier
   below: 'three' -> './three.bundle.js', which exports all eleven names this
   file needs. The decoder itself lives in ./draco/ and is wired up with
   setDecoderPath(); see index.html. */
import {
	BufferAttribute,
	BufferGeometry,
	Color,
